...
#create input point and relation
with NodeControl(set,node2) as nc :
  nc.Input('in1',InputClass = PointClass)
  
with RelationControl(set) as rc :
  rc.in1( node1,node2,InputClass = PointClass)
